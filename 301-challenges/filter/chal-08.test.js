...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
    let regex = /[aeiou]/gi;
    return arr.filter(string=> string.match(regex))
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let newArr = arr.filter(ele =>  (Number.isInteger(ele)) )
  return newArr.map(ele=> ele % 2 === 0 ? 'even': 'odd')
};
